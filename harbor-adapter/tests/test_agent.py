...
class TestCreateRunAgentCommands:
    def test_basic_command_structure(self) -> None:
        ...
        # 8, not the original 15: 48ec042 tuned it down for the benchmark. This
        # assertion kept the old value for months because nothing ran these tests.
        assert "--action-reminder-interval 8" in cmd
